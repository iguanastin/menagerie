...
public abstract class Filters {
    ...
    public static final FileFilter IMAGE_FILTER = file -> {
        ...
        return file.isFile() && name.endsWith(".png") || name.endsWith(".jpg") || name.endsWith(".jpeg") || name.endsWith(".gif");
    };

    public static final FileFilter VIDEO_FILTER = file -> {
        String name = file.getName().toLowerCase();
        return file.isFile() && name.endsWith(".mp4") || name.endsWith(".avi") || name.endsWith(".webm") || name.endsWith(".flv") || name.endsWith(".wmv") || name.endsWith(".3gp") || name.endsWith(".mov") || name.endsWith(".mpg");
    };
